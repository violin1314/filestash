...
export const Icon = (props) => {
    ...
    let baseRoot ="/bhfilebrowser"
    let img;
    if(props.name === 'directory'){
        img = baseRoot+"/assets/icons/folder.png";
    }else if(props.name === 'file'){
        img = baseRoot+"/assets/icons/file.png";
    }else if(props.name === 'save'){
        img = img_save;
    }else if(props.name === 'power'){
        img = img_power;
    }else if(props.name === 'edit'){
        img = baseRoot+"/assets/icons/edit.png";
    }else if(props.name === 'delete'){
        img = baseRoot+"/assets/icons/delete.png";
    }else if(props.name === 'share'){
        img = baseRoot+"/assets/icons/share.png";
