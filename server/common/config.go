	...
	return Configuration{
		...
		form: []Form{
			Form{
				Title: "general",
				Elmnts: []FormElement{
					FormElement{Name: "name", Type: "text", Default: "ServiceCloud", Description: "Name has shown in the UI", Placeholder: "Default: \"ServiceCloud\""},
					FormElement{Name: "port", Type: "number", Default: 8999, Description: "Port on which the application is available.", Placeholder: "Default: 8999"},
					...
					FormElement{Name: "fork_button", Type: "boolean", Default: false, Description: "Display the fork button in the login screen"},
					...
					FormElement{Name: "remember_me", Type: "boolean", Default: false, Description: "Visiblity of the remember me button on the login screen"},
			...
			Form{
				...
				Form: []Form{
					Form{
						Title: "share",
						Elmnts: []FormElement{
							FormElement{Name: "enable", Type: "false", Default: true, Description: "Enable/Disable the share feature"},
						},
					},
				},
			},
